/**
 * SzseSectorSummary Page Component
 * Displays industry sector transaction data for Shenzhen Stock Exchange
 */
...
const SzseSectorSummary: React.FC = () => {
  const [data, setData] = useState<SZSESectorSummaryRaw[]>([]);
  ...
  const fetchSZSESectorSummary = async () => {
    try {
      ...
      console.error('Failed to fetch SZSE sector summary:', err);
...
export default SzseSectorSummary;