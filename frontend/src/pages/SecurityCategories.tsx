/**
 * SecurityCategories Page Component
 * Displays comprehensive security category statistics
 */

import React, { useState, useEffect } from 'react';
import apiClient from '@/services/api';

interface SecurityCategoriesRaw {
  [key: string]: string | number;
}

const SecurityCategories: React.FC = () => {
  const [data, setData] = useState<SecurityCategoriesRaw[]>([]);
  ...
  const fetchSecurityCategories = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await apiClient.get('/market/security-categories');
      ...
      console.error('Failed to fetch security categories:', err);
    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-center">
          ...
          <button
            onClick={fetchSecurityCategories}
